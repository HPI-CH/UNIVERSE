...
if __name__ == '__main__':
    ...
    for data_alignment_job in data_alignment_jobs:
        ...
        if not two_empatica_recordings:
            ...
            # I do not understand why, but for MR_13 the 2nd recording it seems I needed to add a 2 seconds timedelta
            ...
            temp_test_folder_for_storage = '/home/christoph/Desktop/Workflow/Work_2023/UNIVERSE/data/MR_16_zipped/MR_16/1. Lab Session/Empatica/'
    ...
    if simplest_wild_data_synchronization:
        ...
        for idx, muse_csv_info in enumerate(UN_X_muse_csvs):
            ...
            for session_data_to_be_extracted in MR_16_times_and_durations[times_and_durations_idx]:
    ...
    if timestamp_based_synchronization_for_special_lab_cases:
        # TODO: WORK OVER THIS FOR MR_22_1st_Lab! Will have to extract the respective information directly from a
